<header class="header dark-bg">
    ...
    <a class="logo">
        {!!(Auth::check() && Auth::user()->role == 1) 
            ? '<span class="lite">Quản lý</span>' 
            : '<span class="lite">Người dùng</span>'
        !!}
    </a>
    <!--logo end-->
    ...
    <div class="nav search-row" id="top_menu">
        ...
        <span style="font-size: 21px;">HỆ THỐNG QUẢN LÝ MINH CHỨNG HỖ TRỢ CÔNG TÁC ĐÁNH GIÁ TRƯỜNG ĐẠI HỌC</span>
        <!--  search form end -->
    </div>
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    <span class="profile-ava">
                        <img alt="" src="img/aaa.png" style="width: 34px; height: 34px;">
                    </span>
